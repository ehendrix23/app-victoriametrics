...
[**Report a vulnerability**](https://github.com/hassio-addons/app-victoriametrics/security/advisories/new)
...
- Issues in VictoriaMetrics itself; please report those directly to the
  [VictoriaMetrics project](https://github.com/VictoriaMetrics/VictoriaMetrics/security/policy).
...
This security policy covers the VictoriaMetrics app in this repository: the app
